...
import { PlusCircle, MapPin, Calendar, FileText, Package, Image as ImageIcon, Loader2 } from "lucide-react";
...
const AddFood = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // 3. Save to MongoDB via Backend API
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <DatePicker
                                        ...
                                        minDate={new Date()}
                                        className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all z-0"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className={`w-full py-5 rounded-2xl font-black text-lg uppercase tracking-widest flex items-center justify-center transition-all shadow-xl shadow-orange-100 active:scale-95 ${
                                uploading ? 'bg-orange-400 cursor-not-allowed' : 'bg-orange-600 hover:bg-orange-700 text-white'
                            }`}
                        >
                            {uploading ? (
                                <>
